# -*- coding: utf-8 -*-
"""
Created on Sun Apr  7 22:34:48 2024
...
GBtable = pd.read_excel(sheetpath,sheet_name='PC')

patient = GBtable['PatientID']
samples = GBtable['Samples']
# site = GBtable['Tissue Source Site']
# gender = GBtable['gender']
#
data = {'Patient': patient, 'Samples': samples}

df = pd.DataFrame(data=data)


X = np.array(df['Samples'],dtype=np.int16)
